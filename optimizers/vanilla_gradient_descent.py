...
class batch_gradient_descent():
    ...
    def __init__(self, epochs, weight, bias, learning_rate=0.01, x=None, y=None):
        self.epochs = epochs
    ...
    def gradient_descent(self):
        for _ in range(self.epochs):
            ...
            for x, y in zip(self.x, self.y):
                ...
                total_error += err
            # print("dw: ",dw)
            self.w = self.w - self.learning_rate*dw/total_test_points
            self.b = self.b - self.learning_rate*db/total_test_points
...
if __name__ == "__main__":
    gd = batch_gradient_descent(5, 0, 5, 0.05)
    gd.gradient_descent()
